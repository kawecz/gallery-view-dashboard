...
export class GalleryViewSettingTab extends PluginSettingTab {
    ...
    display(): void {
            ...
            rootSetting.addText(text => {
                text.setPlaceholder("e.g., conteudo/cursos")
                    ...
                    .onChange(async (value) => {
                        this.plugin.settings.rootSearchPath = value.trim();
                        await this.plugin.saveSettings();
                        this.broadcastPathChange(this.plugin.settings.rootSearchPath);
                        this.display(); // Force re-render on change
                    });
            ...
            // Ensure button is added even if no manual overrides exist yet
